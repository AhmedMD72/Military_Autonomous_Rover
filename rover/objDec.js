...
function updateTelemetry(data) {
    ...
    if (data.signal) document.getElementById('val-signal').innerText = data.signal + "%";
    ...
    if (data.detectedObjects) {
        if (data.detectedObjects.cars !== undefined) document.getElementById('count-cars').innerText = data.detectedObjects.cars;
        if (data.detectedObjects.rocks !== undefined) document.getElementById('count-rocks').innerText = data.detectedObjects.rocks;
        if (data.detectedObjects.trees !== undefined) document.getElementById('count-trees').innerText = data.detectedObjects.trees;
    }
