// -------------------- Configuration --------------------
const ROBOT_IP = "192.168.100.9";

const ROSBRIDGE_URL = `ws://${ROBOT_IP}:9090`;
const FACE_SERVER_URL = `http://${ROBOT_IP}:8090`;
...
if (photoUploadInput) {
    photoUploadInput.addEventListener("change", async function (event) {
        ...
        // اسم الشخص اللي هيتحفظ في Images ويظهر في detection
